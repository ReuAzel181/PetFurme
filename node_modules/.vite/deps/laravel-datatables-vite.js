    ...
    (function(global, factory) {
      ...
      jQuery7.each({
        ...
        jQuery7.fn[name] = function(until, selector) {
          var matched = jQuery7.map(this, fn2, until);
      ...
      jQuery7.Callbacks = function(options) {
        ...
        var firing, memory, fired, locked, list = [], queue = [], firingIndex = -1, fire = function() {
          ...
          has: function(fn2) {
            return fn2 ? jQuery7.inArray(fn2, list) > -1 : list.length > 0;
          },
      ...
      function Data2() {
        this.expando = jQuery7.expando + Data2.uid++;
      }
      Data2.uid = 1;
      Data2.prototype = {
      ...
      jQuery7.extend({
        ...
        dequeue: function(elem, type) {
          type = type || "fx";
          var queue = jQuery7.queue(elem, type), startLength = queue.length, fn2 = queue.shift(), hooks = jQuery7._queueHooks(elem, type), next = function() {
      ...
      function on(elem, types, selector, data, fn2, one) {
        ...
        if (one === 1) {
          ...
          fn2.guid = origFn.guid || (origFn.guid = jQuery7.guid++);
        }
        return elem.each(function() {
          jQuery7.event.add(this, types, fn2, data, selector);
        });
      }
      jQuery7.event = {
        global: {},
      ...
      jQuery7.fn.extend({
        ...
        off: function(types, selector, fn2) {
          ...
          return this.each(function() {
            jQuery7.event.remove(this, types, fn2, selector);
          });
        }
      });
      ...
      jQuery7.speed = function(speed, easing, fn2) {
      ...
      jQuery7.expr.pseudos.animated = function(elem) {
        return jQuery7.grep(jQuery7.timers, function(fn2) {
      ...
      jQuery7.fn.extend({
        ...
        position: function() {
          ...
          return {
            top: offset2.top - parentOffset.top - jQuery7.css(elem, "marginTop", true),
            left: offset2.left - parentOffset.left - jQuery7.css(elem, "marginLeft", true)
          };
        },
      ...
      jQuery7.each(
        ...
        function(_i, name) {
          jQuery7.fn[name] = function(data, fn2) {
            return arguments.length > 0 ? this.on(name, null, data, fn2) : this.trigger(name);
          };
        }
      );
      var rtrim = /^[\s\uFEFF\xA0]+|([^\s\uFEFF\xA0])[\s\uFEFF\xA0]+$/g;
      jQuery7.proxy = function(fn2, context) {
        var tmp, args, proxy;
        ...
        proxy.guid = fn2.guid = fn2.guid || jQuery7.guid++;
        return proxy;
      };
...
function _fnConvertToWidth(widths, parent) {
  ...
  for (var i2 = 0; i2 < widths.length; i2++) {
    if (widths[i2]) {
      els.push(
        $2("<div/>").css("width", _fnStringToCss(widths[i2])).appendTo(parent || document.body)
      );
    } else {
      els.push(null);
    }
  ...
  */
  ...
  _popover: function(content, hostButton, inOpts, e) {
    ...
    if (position === "absolute") {
      ...
      if (containerPosition.top + top2 < $4(window).scrollTop()) {
...
Buttons.entityDecoder = function(fn2) {
  _entityDecoder = fn2;
};
Buttons.defaults = {
