        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('pets.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                        ...
                        @else
                            <div class="table-responsive">
                                <table class="table table-vcenter card-table">
                                    ...
                                    <tbody>
                                        @foreach($verifiedPets as $pet)
                                            <tr class="pet-row {{ isset($pet['created_by']) && $pet['created_by'] ? 'admin-created' : 'owner-created' }}">
                                                <td>
                                                ...
                                                <td>
                                                    <div>{{ $pet['owner']['name'] }}</div>
                                                    @if(isset($pet['owner']['email']))
                                                        <div class="text-muted">{{ $pet['owner']['email'] }}</div>
                                                    @endif
                                                </td>
                                                <td>{{ $pet['category'] }}</td>
                                                <td>
                                    ...
                                    <tbody>
                                        @foreach($pendingPets as $pet)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($pet['created_by'])
                                                        <span class="badge bg-blue-lt">Staff: {{ $pet['created_by']['name'] }}</span>
                                                    @else
