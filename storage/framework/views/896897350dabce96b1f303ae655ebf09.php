...
<head>
    ...
    <title><?php echo e(config('app.name')); ?> - Pet Care</title>
    
    <!-- Preload critical assets -->
    <link rel="preload" href="<?php echo e(asset('fonts/Inter-Variable.woff2')); ?>" as="font" type="font/woff2" crossorigin>
    ...
    <style>
        @font-face {
            ...
            font-weight: 100 900;
            font-display: swap;
            src: url('<?php echo e(asset('fonts/Inter-Variable.woff2')); ?>') format('woff2');
        }
    </style>
    ...
    <nav class="fixed top-0 left-0 right-0 bg-white shadow-sm z-50 top-nav-height safe-top">
        <div class="flex items-center justify-between px-4 h-full">
            <div class="flex items-center">
                <img src="<?php echo e(asset('storage/defaults/vc_logo.png')); ?>" 
                     alt="VetCare Logo"
                     class="h-8 w-auto">
            ...
            <div class="flex items-center space-x-4">
                ...
                <div class="relative" x-data="{ open: false }">
                    ...
                    <div x-show="open" 
                        ...
                        <a href="<?php echo e(route('pet-owner.profile')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                            <i class="fas fa-user mr-2"></i> Profile
                        </a>
                        <a href="<?php echo e(route('pet-owner.settings')); ?>" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
    ...
    <nav id="bottomNav" class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 z-50">
        <div class="max-w-screen-sm mx-auto px-4">
            <div class="flex items-center justify-between h-16">
                <a href="<?php echo e(route('pet-owner.dashboard')); ?>" 
                   class="nav-item group <?php echo e(request()->routeIs('pet-owner.dashboard') ? 'active' : ''); ?>">
                ...
                <a href="<?php echo e(route('pet-owner.pets.index')); ?>" 
                   class="nav-item group <?php echo e(request()->routeIs('pet-owner.pets.*') ? 'active' : ''); ?>">
                    <div class="relative flex flex-col items-center">
                        <div class="nav-icon-wrapper">
                            <svg class="nav-icon" viewBox="0 0 24 24" fill="none">
                ...
                <a href="<?php echo e(route('pet-owner.appointments.index')); ?>" 
                   class="nav-item group <?php echo e(request()->routeIs('pet-owner.appointments.*') ? 'active' : ''); ?>">
                    <div class="relative flex flex-col items-center">
                        <div class="nav-icon-wrapper">
                            <svg class="nav-icon" viewBox="0 0 24 24" fill="none">
                ...
                <a href="<?php echo e(route('pet-owner.messages.index')); ?>" 
                   class="nav-item group <?php echo e(request()->routeIs('pet-owner.messages.*') ? 'active' : ''); ?>">
                    <div class="relative flex flex-col items-center">
                        <div class="nav-icon-wrapper">
                            <svg class="nav-icon" viewBox="0 0 24 24" fill="none">
...
</html><?php /**PATH D:\XAMPP\htdocs\PetFurme\resources\views/layouts/mobile-app.blade.php ENDPATH**/ ?>