                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    ...
                                    <tr style="cursor: pointer" 
                                        ...
                                        <td>
                                            <?php if($appointment->user && !empty($appointment->user->phone)): ?>
                                                <button type="button" 
                                                        class="btn btn-sm btn-outline-primary send-reminder-btn" 
                                                        data-id="<?php echo e($appointment->id); ?>" 
                                                        data-phone="<?php echo e($appointment->user->phone); ?>" 
                                                        onclick="sendReminder(event, <?php echo e($appointment->id); ?>)">
                                        ...
                                        <td>
                                            <?php echo e($appointment->formatted_reason); ?>
                                        ...
                                        <td>
                                            <?php if($appointment->created_by_type && $appointment->created_by_id): ?>
                                                <?php
                                                ...
                                                <?php if($appointment->created_by_type == 'staff'): ?>
                                                    <?php echo e($creator->name ?? 'Staff Member'); ?> <?php echo $roleLabel; ?>

                                                <?php elseif($appointment->created_by_type == 'user'): ?>
                                                    <?php echo e($creator->name ?? 'User'); ?> <?php echo $roleLabel; ?>

                                                <?php else: ?>
                                                    <?php echo e($appointment->created_by_type); ?> <?php echo $roleLabel; ?>
                                        ...
                                        <td>
                                            <?php echo e($appointment->created_at ? $appointment->created_at->format('M d, Y g:i A') : 'N/A'); ?>
                                        ...
                                        <td>
                                            <?php if($appointment->status !== 'completed'): ?>
                                                ...
                                                <button type="button" 
                                                        ...
                                                        onclick="handleCompleteClick(<?php echo e($appointment->id); ?>, <?php echo e(json_encode($appointmentData)); ?>)"
                                        ...
                                        <td colspan="10" class="text-center py-4">
                                            <div class="empty">
                                                ...
                                                <p class="empty-subtitle text-muted">
                                                    ...
                                                    Past appointments can be found in the <a href="<?php echo e(route('analytics.archives')); ?>">Archives</a>.
                                                </p>
                                            </div>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('components.findings-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php echo $__env->make('components.findings-history-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

<?php $__env->stopSection(); ?>  

<?php $__env->startPush('page-scripts'); ?>
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
<script src="<?php echo e(asset('js/findings.js')); ?>"></script>
<script>
