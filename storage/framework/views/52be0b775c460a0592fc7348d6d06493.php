                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $appointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr style="cursor: pointer" 
                                        onclick="showAppointmentDetails(<?php echo e(json_encode($appointment)); ?>)"
                                        class="appointment-row">
                                        <td onclick="event.stopPropagation()">
                                            <input type="checkbox" class="form-check-input appointment-checkbox" value="<?php echo e($appointment->id); ?>">
                                        </td>
                                        <td class="text-muted">
                                        ...
                                        <td>
                                            <?php if($appointment->status !== 'completed'): ?>
                                                <button type="button" 
                                                        ...
                                                        onclick="initializeMedicalRecord(<?php echo e(json_encode($appointment)); ?>)">
                                                        ...
                                                        <select class="form-select form-select-sm mb-2" name="products[]" onchange="handleProductSelection(this)">
                                                            ...
                                                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <option value="<?php echo e($product->id); ?>" 
                                                                    ...
                                                                    <?php echo e($product->name); ?> (₱<?php echo e(number_format($product->selling_price, 2)); ?>)
                                                                </option>
    ...
    deleteSelected.addEventListener('click', function() {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                fetch('<?php echo e(route("appointment.deleteMultiple")); ?>', {
                    method: 'POST',
                    headers: {
