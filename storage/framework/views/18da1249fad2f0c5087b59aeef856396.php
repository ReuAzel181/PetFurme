                                            ...
                                            <tr class="pet-row <?php echo e(isset($pet['created_by']) && $pet['created_by'] ? 'admin-created' : 'owner-created'); ?>">
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <button onclick="deletePet(<?php echo e($pet['id']); ?>)" class="btn btn-icon btn-danger">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex gap-2">
                                                        ...
                                                        <button onclick="verifyPet(<?php echo e($pet['id']); ?>)" class="btn btn-success d-flex align-items-center gap-1">
