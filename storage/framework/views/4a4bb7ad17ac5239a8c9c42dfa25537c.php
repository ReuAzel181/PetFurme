                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <div class="flex-grow-1">
                                                        <div id="pet_select_container" style="<?php echo e(isset($owner) && $owner->id == 'no_account' ? 'display: none;' : ''); ?>">
                                                            <label class="form-label required">Select Pet</label>
                                                            <select name="pet_id" id="pet_id" class="form-select" <?php echo e(isset($owner) && $owner->id == 'no_account' ? '' : 'required'); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div id="walkin_pet_group" class="col-12" style="<?php echo e(isset($owner) && $owner->id == 'no_account' ? '' : 'display: none;'); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div id="registered_pet_details" class="col-12" style="<?php echo e(isset($pet) && isset($owner) && $owner->id != 'no_account' ? '' : 'display: none;'); ?>; min-height: 300px; margin-bottom: 1.5rem;">
                                <div class="card h-100">
                                    <div class="card-header bg-primary-soft d-flex align-items-center gap-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-paw-filled" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
                                        ...
                                        <div class="row g-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" id="pet_name" class="form-control" readonly 
                                                       value="<?php echo e(isset($pet) ? $pet->name : ''); ?>">
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" id="pet_category" class="form-control" readonly
                                                               value="<?php echo e(isset($pet) ? $pet->category : ''); ?>">
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" id="pet_breed" class="form-control" readonly
                                                               value="<?php echo e(isset($pet) ? $pet->breed : ''); ?>">
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group p-0">
                                                    <input type="number" id="pet_age" class="form-control" readonly
                                                                   value="<?php echo e(isset($pet) ? $pet->age : ''); ?>">
                                                    <select id="age_unit" class="form-select" style="max-width: 100px;" disabled>
                                                        <option value="years" <?php echo e(isset($pet) && $pet->age_unit == 'years' ? 'selected' : ''); ?>>Years</option>
                                                        <option value="months" <?php echo e(isset($pet) && $pet->age_unit == 'months' ? 'selected' : ''); ?>>Months</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="number" id="pet_weight" class="form-control" step="0.01" readonly
                                                               value="<?php echo e(isset($pet) ? $pet->weight : ''); ?>">
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" id="pet_gender" class="form-control" readonly
                                                               value="<?php echo e(isset($pet) ? ucfirst(strtolower($pet->gender)) : ''); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    ownerSelect.addEventListener('change', function() {
        ...
        if (this.value !== 'no_account' && this.value !== '') {
            ...
            ownerAvatar.src = "<?php echo e(asset('storage/defaults/avatar.png')); ?>";
        }
    });
    ...
    function updatePetDetails(pet) {
        ...
        if (avatarField) {
            if (pet.photo_data) {
                ...
                avatarField.src = `<?php echo e(asset('storage/')); ?>/${pet.photo}`;
            } else {
                console.log('Setting default photo');
                avatarField.src = "<?php echo e(asset('storage/defaults/paw.png')); ?>";
            }
        } else {
