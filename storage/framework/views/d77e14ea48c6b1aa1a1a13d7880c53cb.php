                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <img style="width: 90px;"
                                                     src="<?php if($product->product_image_data): ?>
                                                              data:image/jpeg;base64,<?php echo e(base64_encode($product->product_image_data)); ?>

                                                          <?php elseif($product->product_image && Storage::disk('public')->exists($product->product_image)): ?>
                                                              <?php echo e(asset('storage/' . $product->product_image)); ?>

                                                          <?php else: ?>
                                                              <?php echo e(asset('assets/img/products/default.webp')); ?>

                                                          <?php endif; ?>"
                                                     alt="<?php echo e($product->name); ?>">
                                                <div class="font-weight-medium"><?php echo e($product->name); ?></div>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="barcode-container py-1">
                                                <img src="https://bwipjs-api.metafloor.com/?bcid=code128&text=<?php echo e($product->code); ?>&scale=2&includetext&textxalign=center" 
                                                     alt="<?php echo e($product->code); ?>"
                                                     class="barcode-image">
                                                <div class="small text-muted mt-1"><?php echo e($product->code); ?></div>
                                            </div>
                                        </td>
                                        <td class="text-center">
                                        ...
                                        <td class="text-center">
                                            <span class="badge <?php echo e($product->quantity <= $product->quantity_alert ? 'bg-red text-white' : 'bg-green-lt text-green'); ?>">
                                                <?php echo e($product->quantity); ?> <?php echo e($product->unit->short_code); ?>

                                            </span>
                                        </td>
                                        <td class="text-center">
                                            <span class="badge bg-yellow-lt text-warning">
                                                <?php echo e($product->quantity_alert); ?> <?php echo e($product->unit->short_code); ?>

                                            </span>
                                        </td>
                                        <td class="text-center">₱<?php echo e(number_format($product->selling_price, 2)); ?></td>
                                        <td class="text-center text-muted"><?php echo e($product->created_at->format('M d, Y')); ?></td>
                                        <td class="text-center text-muted"><?php echo e($product->updated_at->format('M d, Y')); ?></td>
                                        <td class="text-center">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    <a href="<?php echo e(route('products.show', $product->uuid)); ?>" class="dropdown-item">
                                                    ...
                                                    <a href="<?php echo e(route('products.edit', $product->uuid)); ?>" class="dropdown-item">
                                                    ...
                                                    <form action="<?php echo e(route('products.destroy', $product->uuid)); ?>" method="POST" class="dropdown-item p-0">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.tabler', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\PetFurme\resources\views/products/index.blade.php ENDPATH**/ ?>