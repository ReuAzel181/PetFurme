                    ...
                    <div class="col-md-6 col-lg-8 d-flex flex-column" style="height: 100%; overflow: hidden;">
                        ...
                        <div class="chat-header bg-white border-bottom p-3 d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <div class="me-3">
                                    <?php if($receiver->photo_data): ?>
                                        <img src="data:image/jpeg;base64,<?php echo e(base64_encode($receiver->photo_data)); ?>" 
                                             alt="<?php echo e($receiver->name); ?>" 
                                             class="rounded-circle shadow-sm" 
                                             width="64" 
                                             height="64" 
                                             style="object-fit: cover;">
                                    <?php elseif($receiver->photo): ?>
                                        <img src="<?php echo e(asset('storage/' . $receiver->photo)); ?>" 
                                             alt="<?php echo e($receiver->name); ?>" 
                                             class="rounded-circle shadow-sm" 
                                             width="64" 
                                             height="64" 
                        ...
                        <div class="chat-body flex-grow-1 p-4" style="background-color: #f8f9fa; overflow-y: auto;">
                            <div class="chat-messages" style="display: flex; flex-direction: column;">
                                <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="chat-bubble mb-3 d-flex <?php echo e($message->sender_id === auth()->id() ? 'flex-row-reverse ms-auto' : ''); ?>" 
                                        ...
                                        <div class="chat-avatar" style="min-width: 32px;">
                                            <?php if($message->sender_id === auth()->id()): ?>
                                                <?php if(auth()->user()->photo_data): ?>
                                                    <img src="data:image/jpeg;base64,<?php echo e(base64_encode(auth()->user()->photo_data)); ?>"
                                        ...
                                        <div class="chat-bubble-content" 
                                             style="<?php echo e($message->sender_id === auth()->id() ? 'background-color: #206bc4; color: white;' : 'background-color: #fff;'); ?> 
