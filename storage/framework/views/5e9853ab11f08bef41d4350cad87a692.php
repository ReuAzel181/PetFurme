...
<div class="page-wrapper">
    ...
    <div class="page-body">
        <div class="container-xl">
            <?php if(request()->query('role') === 'pet_owner'): ?>
                    ...
                    <div class="d-flex justify-content-between align-items-center w-100">
                        <div class="btn-group" id="roleToggle">
                            <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <button type="button"
                                   class="btn role-btn <?php echo e(request()->query('role', 'all') === $key ? 'active' : ''); ?>"
                                   data-role="<?php echo e($key); ?>">
                                    <span class="ms-1"><?php echo e($label); ?></span>
                                </button>
                        ...
                        <div class="d-flex gap-2 align-items-center">
                            ...
                            <a href="<?php echo e(route('user-management.create')); ?>" class="btn btn-success">
                                ...
                                <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr style="cursor: pointer;">
                                        <td class="w-1" onclick="event.stopPropagation()">
                                            <input type="checkbox" class="form-check-input user-select" value="<?php echo e($user->id); ?>">
                                        </td>
                                        ...
                                        <td onclick="showUserDetails(<?php echo e($user->id); ?>)"><?php echo e($user->phone ?? '—'); ?></td>
                                        <td onclick="showUserDetails(<?php echo e($user->id); ?>)">
                                            <?php
                                                $roleColors = [
                                            ...
                                            <span class="badge" style="
                                                background-color: <?php echo e($roleColor['bg']); ?>; 
                                        ...
                                        <td onclick="showUserDetails(<?php echo e($user->id); ?>)" class="text-center p-3">
                                            <?php if($user->pets_count > 0): ?>
                                        ...
                                        <td onclick="showUserDetails(<?php echo e($user->id); ?>)">
                                            <?php if($user->complete_credentials): ?>
                                        ...
                                        <td onclick="event.stopPropagation()">
                                            <?php if($user->verified_by): ?>
                                                <form action="<?php echo e(route('user-management.verify', $user->id)); ?>" method="POST" class="d-inline">
                                                    <?php echo csrf_field(); ?>
                                                    ...
                                                    <div class="d-flex align-items-center gap-2" role="button" 
                                                        ...
                                                        <span class="text-azure small d-flex align-items-center gap-1" title="Verified by">
                                                            ...
                                                            <?php echo e(App\Models\User::find($user->verified_by)->name ?? 'Unknown'); ?>

                                                        </span>
                                                    </div>
                                                </form>
                                            <?php else: ?>
                                                <?php if(auth()->user()->role === 'admin' || auth()->user()->role === 'sub_admin'): ?>
                                                    <form action="<?php echo e(route('user-management.verify', $user->id)); ?>" method="POST" class="d-inline">
                                                        <?php echo csrf_field(); ?>
                                                        <button type="submit" 
                                        ...
                                        <td onclick="showUserDetails(<?php echo e($user->id); ?>)"><?php echo e($user->created_at ? $user->created_at->format('Y-m-d') : '—'); ?></td>
                                        <td onclick="showUserDetails(<?php echo e($user->id); ?>)"><?php echo e($user->updated_at ? $user->updated_at->format('Y-m-d') : '—'); ?></td>
                                        <td onclick="event.stopPropagation()">
                                            <div class="d-flex gap-2">
                                                <a href="<?php echo e(route('user-management.edit', $user->id)); ?>" class="btn btn-icon btn-warning btn-sm">
                                                ...
                                                <form action="<?php echo e(route('user-management.destroy', $user->id)); ?>" method="POST" class="d-inline">
                                                    <?php echo csrf_field(); ?>
                                                    <?php echo method_field('DELETE'); ?>
...
<?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="modal modal-lg fade" id="userModal<?php echo e($user->id); ?>" tabindex="-1">
            ...
            <div class="modal-content">
                <div class="modal-header bg-primary text-white py-3">
                    ...
                    <div class="ms-auto d-flex align-items-center gap-2">
                        ...
                        ?>
                        <span class="badge fs-6 bg-<?php echo e($roleColor['lt']); ?>-lt">
                            ...
                            <?php echo e($roleLabels[$user->role] ?? ucfirst(str_replace('_', ' ', $user->role))); ?>
                            ...
                            <div class="p-3">
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-dark fw-medium"><?php echo e($user->phone ?? 'Not provided'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center mb-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-dark fw-medium"><?php echo e($user->address ?? 'Not provided'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-dark fw-medium"><?php echo e($user->created_at->format('M d, Y')); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-9">
                            <div class="p-3">
                                ...
                                <div class="row g-2 mb-4">
                                    <?php echo $__env->make('partials._user_stats', ['user' => $user], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                </div>

                                <!-- Tabs Navigation -->
                                <ul class="nav nav-tabs nav-fill mb-3" role="tablist">
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link active" data-bs-toggle="tab" data-bs-target="#pets-<?php echo e($user->id); ?>" type="button">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#appointments-<?php echo e($user->id); ?>" type="button">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon me-2" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                <path d="M4 5m0 2a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2h-12a2 2 0 0 1-2-2z"></path>
                                                <path d="M16 3v4"></path>
                                                <path d="M8 3v4"></path>
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" data-bs-toggle="tab" data-bs-target="#orders-<?php echo e($user->id); ?>" type="button">
                                            <svg xmlns="http://www.w3.org/2000/svg" class="icon me-2" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <div class="tab-content">
                                    <!-- Pets Tab -->
                                    <div class="tab-pane fade show active" id="pets-<?php echo e($user->id); ?>">
                                        <?php if($user->pets->count() > 0): ?>
                                            <div class="row g-3">
                                                                        ...
                                                                        <div class="d-flex gap-3">
                                                                            ...
                                                                            <div>
                                                                                ...
                                                                                <div class="d-flex gap-2 mt-2">
                                                                                    <span class="badge bg-blue-lt"><?php echo e($pet->type); ?></span>
                                                                                    <span class="badge bg-green-lt">
                                                                                        <?php echo e($pet->age); ?> <?php echo e(Str::plural('month', $pet->age)); ?> old
                                                                                    </span>
                                                                                    <span class="badge bg-purple-lt"><?php echo e(ucfirst($pet->gender)); ?></span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    
                                                                    <a href="<?php echo e(route('appointments.create', ['pet_id' => $pet->id, 'owner_id' => $user->id])); ?>" 
                                    ...
                                    <!-- Appointments Tab -->
                                    <div class="tab-pane fade" id="appointments-<?php echo e($user->id); ?>">
                                        <?php if($user->appointments->count() > 0): ?>
                                            <div class="table-responsive">
                                                <table class="table table-vcenter card-table">
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $user->appointments->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td class="text-nowrap">
                                                                    <div class="d-flex align-items-center">
                                                                        <span class="bg-blue-lt avatar avatar-sm me-2 d-flex align-items-center justify-content-center">
                                                                            <?php echo e($appointment->appointment_date ? Carbon\Carbon::parse($appointment->appointment_date)->format('d') : '--'); ?>

                                                                        </span>
                                                                        <div>
                                                                            <div class="font-weight-medium">
                                                                                <?php echo e($appointment->appointment_date ? Carbon\Carbon::parse($appointment->appointment_date)->format('M Y') : 'No date'); ?>

                                                                            </div>
                                                                            <div class="text-muted small">
                                                                                <?php echo e($appointment->appointment_time ? Carbon\Carbon::parse($appointment->appointment_time)->format('h:i A') : 'No time'); ?>
                                                                ...
                                                                <td>
                                                                    <div class="text-truncate" style="max-width: 150px;">
                                                                        ...
                                                                        <?php if($appointment->other_reason): ?>
                                                                            <div class="text-muted small"><?php echo e($appointment->other_reason); ?></div>
                                                                        <?php endif; ?>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="text-truncate" style="max-width: 100px;">
                                                                        <?php echo e($appointment->pet_name ?? 'No pet name'); ?>

                                                                        <div class="text-muted small"><?php echo e($appointment->pet_type ?? 'No type'); ?></div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                ...
                                                                <td class="text-center">
                                                                    ...
                                                                    ?>
                                                                    <span class="badge bg-<?php echo e($statusColor); ?>-lt">
                                                                        <?php echo e(ucfirst($appointment->status ?? 'Unknown')); ?>
                                    ...
                                    <!-- Orders Tab -->
                                    <div class="tab-pane fade" id="orders-<?php echo e($user->id); ?>">
                                                    ...
                                                    <tbody>
                                                        <?php $__currentLoopData = $user->orders->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <tr>
                                                                <td>
                                                                    <div class="text-truncate" style="max-width: 150px;">
                                                                        <div class="font-weight-medium">#<?php echo e($order->invoice_no ?? 'No invoice'); ?></div>
                                                                        <div class="text-muted small">
                                                                            Ref: <?php echo e($order->reference ?? 'No reference'); ?><br>
                                                                            <?php echo e($order->created_at ? $order->created_at->format('M d, Y h:i A') : 'No date'); ?>
                                                                ...
                                                                <td>
                                                                    <div class="d-flex flex-wrap gap-1" style="max-width: 250px;">
                                                                        <span class="badge bg-blue-lt">
                                                                            <?php echo e($order->total_products ?? 0); ?> items
                                                                        </span>
                                                                        <?php if($order->note): ?>
                                                                            <div class="text-muted small mt-1"><?php echo e($order->note); ?></div>
                                                                        <?php endif; ?>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <span class="badge bg-purple-lt">
                                                                        <?php echo e(ucfirst($order->payment_method ?? 'Not specified')); ?>

                                                                    </span>
                                                                </td>
                                                                <td class="text-end">
                                                                    <div class="text-dark">₱<?php echo e(number_format($order->total ?? 0, 2)); ?></div>
                                                                    <?php if($order->is_paid): ?>
                                                                        <div class="text-muted small">
                                                                            <span class="badge bg-success-lt">
                                                                                Paid <?php echo e($order->paid_at ? Carbon\Carbon::parse($order->paid_at)->format('M d, Y') : ''); ?>

                                                                            </span>
                                                                        </div>
                                                                    <?php endif; ?>
                                                                    <?php if($order->payment_note): ?>
                                                                        <div class="text-muted small"><?php echo e($order->payment_note); ?></div>
                                                                    <?php endif; ?>
                                                                </td>
                                                                <td class="text-center">
                                                                    <?php
                                                                    ...
                                                                    ?>
                                                                    <span class="badge bg-<?php echo e($orderStatusColor); ?>-lt">
                                                                        <?php echo e(ucfirst($order->order_status ?? 'Unknown')); ?>
                ...
                <div class="modal-footer">
                    <div class="btn-list">
                        ...
                        <a href="<?php echo e(route('user-management.edit', $user->id)); ?>" class="btn btn-primary">
...
<script>
    ...
    function exportSelected(format) {
        ...
        form.method = 'POST';
        form.action = `<?php echo e(route('user-management.export-selected')); ?>`;
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        roleButtons.forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                // Make AJAX request
                fetch(`<?php echo e(route('user-management.index')); ?>?role=${role}`, {
                    headers: {
                ...
                .then(html => {
                    ...
                    window.history.pushState({}, '', `<?php echo e(route('user-management.index')); ?>?role=${role}`);
                })
                .catch(error => {
...
<?php echo $__env->make('layouts.tabler', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\PetFurme\resources\views/users/index.blade.php ENDPATH**/ ?>