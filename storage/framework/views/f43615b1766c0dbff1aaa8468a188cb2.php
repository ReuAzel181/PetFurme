                ...
                <div class="btn-group">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="<?php echo e(route('backup.download', 'users')); ?>">Users Backup</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('backup.download', 'pets')); ?>">Pets Backup</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('backup.download', 'orders')); ?>">Orders Backup</a></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('backup.download', 'appointments')); ?>">Appointments Backup</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="<?php echo e(route('backup.download', 'all')); ?>">Full Backup (ZIP)</a></li>
                        </ul>
                    </div>
                    ...
                    <a href="<?php echo e(route('backup.list')); ?>" class="btn btn-info ms-2">
...
<div class="page-body">
    <div class="container-xl">
                ...
                <div class="btn-group w-100" role="group">
                    ...
                    <label class="btn btn-outline-primary users-btn" for="users" style="border-color: #2FB344; color: #2FB344;">
                        ...
                        <span class="badge ms-2" style="background-color: rgba(47, 179, 68, 0.1) !important; color: #2FB344;">
                            <?php echo e($archivedUsers->total()); ?>
                    ...
                    <label class="btn btn-outline-primary orders-btn" for="orders" style="border-color: #F76707; color: #F76707;">
                        ...
                        <span class="badge ms-2" style="background-color: rgba(247, 103, 7, 0.1) !important; color: #F76707;">
                            <?php echo e($archivedOrders->total()); ?>
                    ...
                    <label class="btn btn-outline-primary appointments-btn" for="appointments" style="border-color: #4299E1; color: #4299E1;">
                        ...
                        <span class="badge ms-2" style="background-color: rgba(66, 153, 225, 0.1) !important; color: #4299E1;">
                            <?php echo e($archivedAppointments->count()); ?>
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $archivedUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td>
                                        <img src="<?php echo e($user->photo ? asset('storage/' . $user->photo) : asset('default-avatar.png')); ?>" 
                                    ...
                                    <td class="text-center">
                                        <?php echo e($user->deleted_at->format('M d, Y g:i A')); ?>
                                    ...
                                    <td class="text-center">
                                        <?php if($user->deletedBy): ?>
                                            <div class="d-flex align-items-center justify-content-center gap-2">
                                                <span class="avatar avatar-xs rounded-circle bg-blue-lt">
                                                    <?php echo e(strtoupper(substr($user->deletedBy->name, 0, 1))); ?>

                                                </span>
                                                <span><?php echo e($user->deletedBy->name); ?></span>
                                            </div>
                                        <?php else: ?>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <button class="btn btn-icon btn-outline-primary btn-sm" 
                                                    ...
                                                    data-bs-target="#viewUserModal<?php echo e($user->id); ?>"
                                                    title="View Details">
                                            ...
                                            <button class="btn btn-icon btn-outline-primary btn-sm" 
                                                    onclick="restoreUser('<?php echo e($user->id); ?>')" 
                                                    title="Restore User">
        ...
        <!-- User Details Modal -->
        <?php $__currentLoopData = $archivedUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="modal modal-blur fade" id="viewUserModal<?php echo e($user->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-control-plaintext"><?php echo e(ucfirst($user->role)); ?></div>
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Archived Date</label>
                                <div class="form-control-plaintext"><?php echo e($user->deleted_at->format('M d, Y H:i')); ?></div>
                            </div>
                        </div>
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-vcenter card-table">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $archivedPets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="text-center"><?php echo e($pet->name); ?></td>
                                    <td class="text-center">
                                        <div class="d-flex align-items-center justify-content-center gap-2">
                                            <?php if($pet->user): ?>
                                                <span class="avatar avatar-sm rounded-circle bg-primary-lt">
                                                    <?php echo e(strtoupper(substr($pet->user->name, 0, 1))); ?>

                                                </span>
                                                <span><?php echo e($pet->user->name); ?></span>
                                            <?php else: ?>
                                    ...
                                    <td class="text-center"><?php echo e($pet->category); ?></td>
                                    <td class="text-center"><?php echo e($pet->breed); ?></td>
                                    <td class="text-center">
                                        <?php echo e($pet->deleted_at->format('M d, Y g:i A')); ?>

                                        <div class="text-muted small">
                                            <?php echo e($pet->deleted_at->diffForHumans()); ?>

                                        </div>
                                    </td>
                                    <td class="text-center">
                                        <?php if($pet->deletedBy): ?>
                                            <div class="d-flex align-items-center justify-content-center gap-2">
                                                <span class="avatar avatar-xs rounded-circle bg-blue-lt">
                                                    <?php echo e(strtoupper(substr($pet->deletedBy->name, 0, 1))); ?>

                                                </span>
                                                <span><?php echo e($pet->deletedBy->name); ?></span>
                                            </div>
                                        <?php else: ?>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <button class="btn btn-icon btn-outline-primary btn-sm" 
                                                    data-bs-toggle="modal" 
                                                    data-bs-target="#viewPetModal<?php echo e($pet->id); ?>"
                                                    title="View Details">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                                    <path d="M10 12a2 2 0 1 0 4 0a2 2 0 0 0 -4 0"/>
                                            ...
                                            <button class="btn btn-icon btn-outline-primary btn-sm" 
                                                    onclick="restorePet('<?php echo e($pet->id); ?>')" 
                                                    title="Restore Pet">
                    ...
                    <table class="table table-vcenter card-table">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $archivedOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td class="fw-bold text-blue"><?php echo e($order->invoice_no); ?></td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="badge bg-<?php echo e($order->order_status_color); ?>-lt">
                                    ...
                                    <td class="text-center">
                                        <?php if($order->deleted_at): ?>
                                            <?php echo e($order->deleted_at->format('M d, Y g:i A')); ?>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex align-items-center justify-content-center gap-2">
                                            <?php if($order->deletedBy): ?>
                                                <span class="avatar avatar-xs rounded-circle bg-blue-lt">
                                                    <?php echo e(strtoupper(substr($order->deletedBy->name, 0, 1))); ?>

                                                </span>
                                                <span><?php echo e($order->deletedBy->name); ?></span>
                                            <?php else: ?>
                                                <span class="text-muted">
                                                    <i class="fas fa-user-circle me-1"></i>
                                                    <?php if($order->deleted_by): ?>
                                                        Deleted User (ID: <?php echo e($order->deleted_by); ?>)
                                                    <?php else: ?>
                                                        System
                                                    <?php endif; ?>
                                                </span>
                                    ...
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <button class="btn btn-icon btn-outline-primary btn-sm" 
                                                    data-bs-toggle="modal" 
                                                    data-bs-target="#viewOrderModal<?php echo e($order->id); ?>"
                                                    title="View Details">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                                                    <path d="M10 12a2 2 0 1 0 4 0a2 2 0 0 0 -4 0"/>
                                            ...
                                            <button class="btn btn-icon btn-outline-primary btn-sm" 
                                                    onclick="restoreOrder('<?php echo e($order->id); ?>')" 
                                                    title="Restore Order">
                                                <i class="fas fa-undo"></i>
                                            </button>
                                        </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between mb-3">
                    ...
                    <div class="ms-auto text-muted">
                        Total: <strong><?php echo e($totalAppointments); ?></strong>
                        <span class="mx-2">|</span>
                        Completed: <strong><?php echo e($completedAppointments); ?></strong>
                        <span class="mx-2">|</span>
                        Cancelled: <strong><?php echo e($cancelledAppointments); ?></strong>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table table-vcenter card-table">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $archivedAppointments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $appointment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <span class="avatar avatar-xs me-2 rounded-circle bg-blue-lt">
                                                <?php echo e(strtoupper(substr($appointment->user->name ?? $appointment->owner_name, 0, 1))); ?>

                                            </span>
                                            <span><?php echo e($appointment->user->name ?? $appointment->owner_name); ?></span>
                                        </div>
                                    </td>
                                    <td><?php echo e($appointment->pet->name ?? $appointment->pet_name); ?></td>
                                    <td><?php echo e(\Carbon\Carbon::parse($appointment->appointment_date)->format('M d, Y g:i A')); ?></td>
                                    <td>
                                        <?php
                                        ...
                                        <?php if(is_array($reasons)): ?>
                                            <ul class="list-unstyled mb-0">
                                                <?php $__currentLoopData = $reasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reason): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li><small>• <?php echo e($reason); ?></small></li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </ul>
                                        <?php else: ?>
                                            <?php echo e($reasons); ?>
                                    ...
                                    <td>
                                        <span class="badge bg-<?php echo e($appointment->status === 'completed' ? 'success' : 'warning'); ?>-lt">
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <form action="<?php echo e(route('appointment.restore', $appointment->id)); ?>" method="POST" class="d-inline">
                                                <?php echo csrf_field(); ?>
...
<!-- Order Details Modal -->
<?php $__currentLoopData = $archivedOrders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php echo $__env->make('orders.partials.archived-order-modal', ['order' => $order], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

<!-- Add Pet View Modal -->
<?php $__currentLoopData = $archivedPets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pet): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <div class="modal modal-blur fade" id="viewPetModal<?php echo e($pet->id); ?>" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <div class="form-control-plaintext"><?php echo e($pet->name); ?></div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Owner</label>
                        <div class="form-control-plaintext">
                            <?php echo e($pet->user ? $pet->user->name : ($pet->owner_name ?? 'Unknown Owner')); ?>

                        </div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Category</label>
                        <div class="form-control-plaintext"><?php echo e($pet->category); ?></div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Breed</label>
                        <div class="form-control-plaintext"><?php echo e($pet->breed); ?></div>
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Archived Date</label>
                        <div class="form-control-plaintext"><?php echo e($pet->deleted_at->format('M d, Y H:i')); ?></div>
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
...
function triggerAutoBackup() {
    fetch('<?php echo e(route("backup.auto")); ?>', {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
            'Accept': 'application/json',
...
<?php echo $__env->make('layouts.tabler', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\PetFurme\resources\views/analytics/archives.blade.php ENDPATH**/ ?>