    ...
    <div class="card stat-card h-100">
        <div class="card-body p-2">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <div class="font-weight-medium"><?php echo e($user->pets_count); ?></div>
                    <div class="text-muted small"><?php echo e(Str::plural('Pet', $user->pets_count)); ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card stat-card h-100">
        <div class="card-body p-2">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <div class="font-weight-medium"><?php echo e($user->appointments_count); ?></div>
                    <div class="text-muted small"><?php echo e(Str::plural('Appointment', $user->appointments_count)); ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card stat-card h-100">
        <div class="card-body p-2">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <div class="font-weight-medium"><?php echo e($user->orders_count); ?></div>
                    <div class="text-muted small"><?php echo e(Str::plural('Order', $user->orders_count)); ?></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card stat-card h-100">
        <div class="card-body p-2">
            <div class="d-flex align-items-center">
                ...
                <div>
                    <div class="font-weight-medium">₱<?php echo e(number_format($user->orders->sum('total'), 2)); ?></div>
                    <div class="text-muted small">Total Spent</div>
                </div>
            </div>
        </div>
    </div>
</div> <?php /**PATH D:\XAMPP\htdocs\PetFurme\resources\views/partials/_user_stats.blade.php ENDPATH**/ ?>