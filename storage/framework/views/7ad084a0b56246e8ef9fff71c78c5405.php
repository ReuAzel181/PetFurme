        ...
        <div class="col-md-11">
            <div class="card shadow-sm">
                <div class="card-header bg-white">
                    <h3 class="card-title fs-1 fw-bold"><?php echo e(__('New Pet Registration')); ?></h3>
                </div>

                <div class="card-body p-4">
                    <form method="POST" action="<?php echo e(route('pets.store')); ?>" enctype="multipart/form-data" id="petForm" data-binary="true">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="row mb-4">
                            <div class="col-md-12">
                                ...
                                <select name="user_id" class="form-select form-select-lg fs-4" required id="ownerSelect">
                                    ...
                                    <?php $__currentLoopData = \App\Models\User::where('role', 'pet_owner')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $owner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <div class="position-relative">
                                                <label for="photo" class="photo-upload-label cursor-pointer">
                                                    <div class="position-relative">
                                                        <img id="preview" src="<?php echo e(asset('storage/defaults/paw.png')); ?>" 
...
document.getElementById('petForm').addEventListener('submit', async function(e) {
    ...
    async function submitForm(formData) {
        ...
        try {
            const response = await fetch('<?php echo e(route('pets.store')); ?>', {
                method: 'POST',
                body: formData,
...
<?php echo $__env->make('layouts.tabler', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\PetFurme\resources\views/pet/create.blade.php ENDPATH**/ ?>