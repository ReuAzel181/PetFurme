        ...
        <div class="col-md-11">
            <div class="card shadow-sm">
                ...
                <div class="card-body p-4">
                    <form method="POST" action="<?php echo e(route('pets.store')); ?>" enctype="multipart/form-data" id="petForm">
                        <?php echo csrf_field(); ?>
                                        ...
                                        <div class="d-flex flex-column align-items-center">
                                            ...
                                            <div class="position-relative">
                                                <label for="photo" class="photo-upload-label cursor-pointer">
                                                    <div class="position-relative">
                                                        <img id="preview" src="<?php echo e(asset('images/default-pet-avatar.png')); ?>" 
