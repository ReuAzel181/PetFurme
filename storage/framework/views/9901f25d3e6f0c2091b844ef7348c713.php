        ...
        <div class="row row-cards">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="list-group list-group-flush">
                            <a href="<?php echo e(route('settings.store')); ?>" class="list-group-item list-group-item-action">
                            ...
                            <a href="<?php echo e(route('settings.invoice')); ?>" class="list-group-item list-group-item-action">
                                <div class="row align-items-center">
                                    <div class="col-auto">
            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="list-group list-group-flush">
                            <a href="<?php echo e(route('settings.notifications')); ?>" class="list-group-item list-group-item-action">
                                <div class="row align-items-center">
                                    <div class="col-auto">
                            ...
                            <a href="<?php echo e(route('settings.backup')); ?>" class="list-group-item list-group-item-action">
                                <div class="row align-items-center">
                                    <div class="col-auto">
...
<?php echo $__env->make('layouts.tabler', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\XAMPP\htdocs\PetFurme\resources\views/settings/index.blade.php ENDPATH**/ ?>