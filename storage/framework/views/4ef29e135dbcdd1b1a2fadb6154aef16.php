                    ...
                    <div id="authCarousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                ...
                                ?>
                                <img src="<?php echo e($imagePath1); ?>" class="carousel-image" alt="Welcome" onerror="Logger::log('Image failed to load: <?php echo e($imagePath1); ?>');">
                            ...
                            <div class="carousel-item">
                                ...
                                ?>
                                <img src="<?php echo e($imagePath2); ?>" class="carousel-image" alt="Services" onerror="Logger::log('Image failed to load: <?php echo e($imagePath2); ?>');">
                                <div class="carousel-overlay"></div>
                            </div>
                            <div class="carousel-item">
                                <?php
                                ...
                                ?>
                                <img src="<?php echo e($imagePath3); ?>" class="carousel-image" alt="Health" onerror="Logger::log('Image failed to load: <?php echo e($imagePath3); ?>');">
                                <div class="carousel-overlay"></div>
                            </div>
                        </div>
            ...
            <div class="col-lg-6">
                    <div class="login-section">
                        <div class="form-header text-center">
                            <img src="<?php echo e(asset('storage/defaults/vc_logo.png')); ?>" alt="VetCare Logo" height="66" class="navbar-brand-image">
                            <div id="headerText">
                            ...
                            <div class="login-form-container" id="loginForm" style="margin-bottom: 70px;">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-icon">
                                        ...
                                        <input type="email" name="email" id="loginEmail" class="form-control <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>" placeholder="your@email.com" value="<?php echo e(old('email')); ?>" required>
                                    </div>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mb-3">
                                        ...
                                        <?php if(Route::has('password.request')): ?>
                                                <a href="<?php echo e(route('password.request')); ?>" class="text-muted small">Forgot password?</a>
                                        <?php endif; ?>
                                    </div>
                                        <div class="input-icon">
                                            <span class="input-icon-addon">
...
unset($__errorArgs, $__bag); ?>" placeholder="Your password" required>
                                            <span class="input-icon-addon">
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-check">
                                                <input type="checkbox" name="terms-of-service" class="form-check-input <?php $__errorArgs = ['terms-of-service'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"/>
                                            ...
                                            <?php $__errorArgs = ['terms-of-service'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        <?php if($errors->any()): ?>
            console.log('Validation errors:', <?php echo json_encode($errors->all(), 15, 512) ?>); // Debug
            <?php if(old('_token') && !old('email')): ?>
                loginForm.style.display = 'none';
                registerForm.style.display = 'block';
            <?php endif; ?>
        <?php endif; ?>
